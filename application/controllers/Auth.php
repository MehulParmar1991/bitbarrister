...
//ALTER TABLE `demo_user_profiles` ADD `uadd_country_code` VARCHAR(255) NULL DEFAULT NULL AFTER `upro_phone`;
if (!defined('BASEPATH'))
...
//		
    ...
    public function include_files() {
        ...
        $this->data['common'] = $this->load->view('includes/common', NULL, TRUE);
        $this->data['footer'] = $this->load->view('includes/footer', NULL, TRUE);
        return $this->data;
    }
